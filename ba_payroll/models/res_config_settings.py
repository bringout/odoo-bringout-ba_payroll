...
class ResConfigSettings(models.TransientModel):
    ...
    leaves_positive = fields.Boolean(
        config_parameter="ba_payroll.leaves_positive",
    ...
    allow_cancel_payslips = fields.Boolean(
        config_parameter="ba_payroll.allow_cancel_payslips",
    ...
    prevent_compute_on_confirm = fields.Boolean(
        config_parameter="ba_payroll.prevent_compute_on_confirm",
    ...
    allow_edit_payslip_lines = fields.Boolean(
        config_parameter="ba_payroll.allow_edit_payslip_lines",
    ...
    require_code_and_category = fields.Boolean(
        config_parameter="ba_payroll.require_code_and_category",
