...
class ContributionRegisterReport(models.AbstractModel):
    _name = "report.ba_payroll.report_contributionregister"
    ...
    def _get_payslip_lines(self, register_ids, date_from, date_to):
        ...
        for line in self.env["ba.hr.payslip.line"].browse(line_ids):
            result.setdefault(line.register_id.id, self.env["ba.hr.payslip.line"])
    ...
    def _get_report_values(self, docids, data=None):
        ...
        contrib_registers = self.env["ba.hr.contribution.register"].browse(register_ids)
        ...
        return {
            ...
            "doc_model": "ba.hr.contribution.register",
